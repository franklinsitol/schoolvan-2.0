  ...
  const handleConfirmConversion = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newStudentData: Omit<Student, 'id'> = {
        ...
        shift: convertModalLead.shift || 'Manhã',
        grade: convertModalLead.shift || 'Manhã',
        entryTime: convertModalLead.entryTime || (convertModalLead.shift === 'Tarde' ? '13:00' : '07:00'),
        exitTime: convertModalLead.exitTime || (convertModalLead.shift === 'Tarde' ? '18:00' : '12:00'),
